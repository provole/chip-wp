...
function setBannerInnerWidth() {
  var bannerWidth = $(".home-banner").outerWidth();
  var inners = $(".home-banner .inner");
  inners.css({
...
function hideSection1() {
  var textInner = $(".home-banner").find(".section-1 .text");
  textInner.children().each(function (index, item) {
    $(item).css({
      opacity: 0
    });
...
function setMouseMove() {
  $(".home-banner").off("mousemove").on("mousemove", function (e) {
    var bannerWidth = $(this).outerWidth();
...
function setMouseLeave() {
  $(".home-banner").off("mouseleave").on("mouseleave", function () {
    $(this).find(".section-1").animate({
      width: "50%"
    }, "fast");
...
function setMouseEnter() {
  $(".home-banner").off("mouseenter").on("mouseenter", function () {
    if (sliderActive) {
      $(this).find(".heading").animate({
        opacity: 1
      }, "fast");
...
function setTouchEvents() {
  $(".home-banner").on("touchmove", function (e) {
    ...
    if ($(".home-banner .heading").css("opacity") > 1) {
      $(".home-banner .heading").stop(true, true).animate({
        opacity: 1
      }, "fast");
    }

    var touchobj = e.changedTouches[0];
    startx = parseInt(touchobj.clientX); // starty = parseInt(touchobj.clientY);
    ...
    if (percent) {
      // section1
      $(".home-banner .section-1").stop(true, true).css({
        width: percent + "%"
      });
...
function setClickEvents() {
  $(".home-banner").off("click").on("click", function (e) {
    e.preventDefault();
    var bannerWidth = $(this).outerWidth();
    var position = e.clientX;
    percent = Math.round(position / bannerWidth * 100);
    ...
    if (!sectionActive) {
      ...
      $(".home-banner .section-" + (sections.indexOf(sectionActive) + 1) + " .text").hide();
      $(".home-banner .heading").animate({
        opacity: 1
      }, "fast");
      sectionActive = false;
...
if ($('section.points').length) {
  var calculateBarOffset = function calculateBarOffset() {
    if ($(window).outerWidth() < 820) {
      console.log($(".points .heading").height());
      console.log($(".points .line-mobile"));
      $('.points .line-mobile').css({
        transform: 'translate( -50%, calc( -50% + ' + $('.points .heading').height() + 'px - 2px )'
      });
    } else {
      $('.points .line-mobile').css({
...
$(".expansion-btn").on("click", function () {
  ...
  if (!$(toGetId).hasClass("expanded-div")) {
    $(".single-post__slide").removeClass("compressed-div expanded-div").addClass("compressed-div");
...
$(window).on("load", function () {
  ...
  $(".thumbs > div img").on("click", function () {
    var thmb = this;
    var src = this.src;
    $(thmb).parent().parent(".thumbs").prev(".bottlesWrapper").find("img").fadeOut(400, function () {
      thmb.src = this.src;
...
/* harmony import */ var _mobileNav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mobileNav */ "./src/js/mobileNav.js");
/* harmony import */ var _mobileNav__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_mobileNav__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _banner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./banner */ "./src/js/banner.js");
...
/* harmony import */ var _single_post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./single-post */ "./src/js/single-post.js");
/* harmony import */ var _single_post__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_single_post__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sliders */ "./src/js/sliders.js");
/* harmony import */ var _points__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./points */ "./src/js/points.js");
/* harmony import */ var _points__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_points__WEBPACK_IMPORTED_MODULE_5__);
